...
export default function EditEventPage() {
  ...
  const fetchData = async () => {
    try {
      ...
      if (eventResponse.success && eventResponse.data) {
        ...
        throw new Error(
          eventResponse.message || "Không thể tải thông tin sự kiện",
        );
      }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(
        error.message || "Cập nhật sự kiện thất bại. Vui lòng thử lại.",
      );
    } finally {
      setSaving(false);
    }
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
              ...
              <p className="text-yellow-700 mb-4">
                Sự kiện này đang ở trạng thái "{event.status}" và không thể
                chỉnh sửa. Chỉ các sự kiện ở trạng thái "Nháp" mới có thể được
                chỉnh sửa.
              </p>
              <button
