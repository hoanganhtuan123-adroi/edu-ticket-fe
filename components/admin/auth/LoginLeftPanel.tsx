...
export default function LoginLeftPanel() {
  return (
    <div className="gradient-bg text-white p-6 sm:p-8 lg:p-12 lg:w-2/5 flex flex-col justify-between relative overflow-hidden rounded-l-2xl lg:rounded-l-2xl shadow-2xl flex-1 lg:flex-initial">
      <div className="relative z-10">
        ...
        >
          ...
          >
            ...
            <motion.div 
              className="flex flex-col sm:flex-row sm:items-center sm:space-x-4 text-sm text-blue-200 space-y-2 sm:space-y-0"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              >
                ...
                <span className="text-xs sm:text-sm">An toàn & Bảo mật</span>
              </motion.div>
              <motion.div 
                className="flex items-center space-x-2"
                whileHover={{ scale: 1.05 }}
              ...
              >
                <i className="fas fa-check-circle"></i>
                <span className="text-xs sm:text-sm">Dễ sử dụng</span>
              </motion.div>
            </motion.div>
          </motion.div>
        </motion.div>
